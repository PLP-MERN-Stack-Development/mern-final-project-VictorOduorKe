  ...
  return (
    <header className="bg-white shadow-md fixed w-full top-0 left-0 z-50">
      <div className="mazx-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        {/* Logo */}
        <Link to="/" className="text-2xl font-bold text-violet-600 hover:text-violet-700 transition-colors flex gap-1">
        <img className="w-10 h-10 bg-black rounded-full" src="/AiLOgo.png" alt="LOGO" />
